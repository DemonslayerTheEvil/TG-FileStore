# (c) @chat_supo || @Eagle_PredatorZBot
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        try:
            ...
            share_link = f"https://t.me/{Config.BOT_USERNAME}?start=Eagle_PredatorZBot_{str_to_b64(file_er_id)}"
                ...
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://t.me/Eagle_PredatorZBot")
                    ],
                    [
        ...
        await cmd.message.edit(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Source Codes of Bot",
                                             url="https://t.me/Eagle_PredatorZBot/TG-FileStore")
                    ],
                    [
                        InlineKeyboardButton("About Bot", callback_data="aboutbot"),
                        InlineKeyboardButton("Go Home", callback_data="gotohome")
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Sorry Sir, You are Banned to use me. Contact my [Support Group](https://t.me/chat_supo).",
                        disable_web_page_preview=True
                    )
                    return
